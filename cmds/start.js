...
module.exports.run = async (bot, message, args) => {
    ...
    let startMessage = new Discord.RichEmbed()
        ...
        .setDescription("Please enter the last 3 digits of your server identifier. When in-game, you find this in the top left corner of your screen.")
        .setColor("#8600b3")
        .setFooter("Darkest Light");
